...
public class LevelOrderTest {
    ...
    public void testTraverse() throws Exception {
        ...
        TreeNode tree = TreeNode.builder().val(1).
            left(TreeNode.builder().val(2).build()).right(TreeNode.builder().val(3).build())
            .build();
        assertThat(levelOrder.traverse(tree))
            .containsSequence(Arrays.asList(1), Arrays.asList(2, 3));
    ...
    public void testTraverseFromBottom() throws Exception {
        ...
        TreeNode tree = TreeNode.builder().val(1).
            left(TreeNode.builder().val(2).build()).right(TreeNode.builder().val(3).build())
            .build();
        assertThat(levelOrder.traverseFromBottom(tree))
            .containsSequence(Arrays.asList(2, 3), Arrays.asList(1));
    ...
    public void testZigzagTraversal() throws Exception {
        ...
        assertThat(levelOrder.zigzagTraversal(tree))
            .containsSequence(Arrays.asList(3), Arrays.asList(20, 9), Arrays.asList(15, 7));
        ...
        assertThat(levelOrder.zigzagTraversal(tree))
            .containsSequence(Arrays.asList(1), Arrays.asList(3, 2), Arrays.asList(4, 5));
        assertThat(levelOrder.traverseFromBottom(null)).isEmpty();
    }
